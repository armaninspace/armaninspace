...
{\it Derivation.} The event $X=k$ means that when the $r-$th failure occurd there were exactly $k$ successes. In particular it means that the process stopeed at $(k+r)$-th experiment:
$$
...
{\it Derivation.} Expectation is the first derivative $M'(0).$ We have 
$$
