...
{\it Derivation.} Let $\xi_l,$ $l=1,2,\ldots,n,$  be the result of $l$-th experiment, $\xi_l\in\{1,2,\ldots,k\}.$ The event 
$$
...
{\it Derivation.} The moment generating function of a single variable $X_j$ is obtained from $M(t_1,\ldots,t_k)$ by letting $t_i=0,$ $i\ne j.$ That is 
$$
